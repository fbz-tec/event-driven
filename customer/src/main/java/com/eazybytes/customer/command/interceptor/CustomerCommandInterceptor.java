...
public class CustomerCommandInterceptor implements MessageDispatchInterceptor<CommandMessage<?>> {
    ...
    public BiFunction<Integer, CommandMessage<?>, CommandMessage<?>> handle(@Nonnull List<? extends CommandMessage<?>> messages) {
        return (index, command) -> {
            if (CreateCustomerCommand.class.equals(command.getPayload().getClass())) {
            ...
            } else if (UpdateCustomerCommand.class.equals(command.getPayload().getClass())) {
            ...
            else if (DeleteCustomerCommand.class.equals(command.getPayload().getClass())) {
